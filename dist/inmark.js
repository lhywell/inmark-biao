...
var _export = __webpack_require__(413);
...
var _dom = __webpack_require__(410);
...
var BImage = function (_Init) {
    ...
    function BImage(opts) {
        ...
        if (opts) {
            ...
            _this._option.offsetM = 0;
            _this._option.offsetN = 0;
            ...
            if (opts.style) {
                _this._imgConfig = (0, _utils.merge)(_ImageConfig2.default.style, opts.style);
            } else {
                _this._imgConfig = _ImageConfig2.default.style;
            }
        ...
        value: function renderImg(url) {
            ...
            img.onload = function () {
                if (_this2._option.mode === 'auto') {
                    ...
                    var refresh = new _zrender2.default.Image({
                        style: _extends({
...
var HandlerProxy = __webpack_require__(412);
...
var Transformable = __webpack_require__(432);

var Animatable = __webpack_require__(430);
...
var smoothSpline = __webpack_require__(419);

var smoothBezier = __webpack_require__(418);
...
var transformPath = __webpack_require__(439);
                ...
                if (e.event.target.tagName === 'CANVAS') {
                    ...
                    switch (_side) {
                        case 'tl':
                            ...
                            newPoints = [[(offsetX - _this6._option.offsetM) / m[0] - bgDragX, (offsetY - _this6._option.offsetN) / m[0] - bgDragY], [oldPoints[1][0], (offsetY - _this6._option.offsetN) / m[0] - bgDragY], oldPoints[2], [(offsetX - _this6._option.offsetM) / m[0] - bgDragX, oldPoints[3][1]]];
                            break;
                        ...
                        case 'tr':
                            ...
                            newPoints = [[oldPoints[0][0], (offsetY - _this6._option.offsetN) / m[0] - bgDragY], [(offsetX - _this6._option.offsetM) / m[0] - bgDragX, (offsetY - _this6._option.offsetN) / m[0] - bgDragY], [(offsetX - _this6._option.offsetM) / m[0] - bgDragX, oldPoints[3][1]], oldPoints[3]];
                            break;
                        ...
                        case 'br':
                            ...
                            newPoints = [oldPoints[0], [(offsetX - _this6._option.offsetM) / m[0] - bgDragX, oldPoints[0][1]], [(offsetX - _this6._option.offsetM) / m[0] - bgDragX, (offsetY - _this6._option.offsetN) / m[0] - bgDragY], [oldPoints[0][0], (offsetY - _this6._option.offsetN) / m[0] - bgDragY]];
                            break;
                        ...
                        case 'bl':
                            ...
                            newPoints = [[(offsetX - _this6._option.offsetM) / m[0] - bgDragX, oldPoints[0][1]], oldPoints[1], [oldPoints[2][0], (offsetY - _this6._option.offsetN) / m[0] - bgDragY], [(offsetX - _this6._option.offsetM) / m[0] - bgDragX, (offsetY - _this6._option.offsetN) / m[0] - bgDragY]];
                            break;
                    }
                    group.removeAll();
...
var RectOverlay = function (_Image) {
    ...
    _createClass(RectOverlay, [{
        ...
        value: function _createShape(points, data) {
            ...
            shape.on('dragend', function (e) {
                if (e.which === 1) {
                    ...
                    _this5.position = _zrender2.default.util.clone(_shape.position);

                    var shapePoints = _this5._toShapeDragEnd(e, _shape);

                    _this5.currShape = _shape;
            ...
            shape.on('mouseup', function (e) {
                if (_this5.isOpen && _this5.selectedSub && e.which === 1) {
                    _this5._startPoint = [];
        ...
        value: function _reCreatePoints(points) {
            ...
            var shape = this._createShape(points, this.currShape.data);
        ...
        value: function _editElementEvent(editNode, group) {
            ...
            editNode.on('dragstart', function (e) {
                ...
                if (e.which === 1) {
                    var m = _this7.currShape.transform;
                    var point = _this7.currShape.shape.points;
                    var oldPoints = _zrender2.default.util.clone(point);
                    ...
                    _this7.m = _zrender2.default.util.clone(_this7.currShape.transform || []);
                }
            });
            ...
            editNode.on('drag', function (e) {
                if (e.event.target.tagName === 'CANVAS' && e.which === 1) {
                    ...
                    _this7._onEditNodeDrag && _this7._onEditNodeDrag(e, _extends({}, group.bound.data, {
                        coordinates: rPoints
                    }));
        ...
        value: function resetShapeStyle() {
            ...
            this._areaShapes.forEach(function (item) {
                if (item.data.type === 'Rectangle') {
                    item.attr({
                        style: _extends({}, _this9._styleConfig.default, {
                            stroke: stroke
                        }),
                        draggable: false
                    });
...
var _fourPointsTransform = __webpack_require__(411);
...
var _parseSVG = __webpack_require__(438);
...
var _CompoundPath = __webpack_require__(414);
...
var _IncrementalDisplayable = __webpack_require__(415);

exports.IncrementalDisplayable = _IncrementalDisplayable;

var _Arc = __webpack_require__(420);

exports.Arc = _Arc;

var _BezierCurve = __webpack_require__(421);
...
var _Droplet = __webpack_require__(422);
...
var _Heart = __webpack_require__(423);

exports.Heart = _Heart;

var _Isogon = __webpack_require__(424);
...
var _Ring = __webpack_require__(425);

exports.Ring = _Ring;

var _Rose = __webpack_require__(426);

exports.Rose = _Rose;

var _Sector = __webpack_require__(427);

exports.Sector = _Sector;

var _Star = __webpack_require__(428);

exports.Star = _Star;

var _Trochoid = __webpack_require__(429);
...
var _RadialGradient = __webpack_require__(416);
...
var fixClipWithShadow = __webpack_require__(417);
...
var GradientManager = __webpack_require__(435);

var ClippathManager = __webpack_require__(434);

var ShadowManager = __webpack_require__(436);
...
var Painter = __webpack_require__(433);
...
var Painter = __webpack_require__(440);
